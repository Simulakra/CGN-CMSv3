...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="#"><i class="fa fa-cart-arrow-down"></i> Fatura ile Ürün Alışı</a></li>
				...
				<table class="table">
					<tr>
						<td>
							...
							<input class="form-control" type="" name="faturano">
						</td>
						<td>
					...
					<tr>
						<td>
							<label>Fatura İskonto Oranı:</label>
							<input class="form-control" type="" name="iskonto">
						</td>
						<td>
							<label>Bedelsiz Ürün:</label>
							<input class="form-control" type="number" min="0" value="0" name="bedelsiz">
						</td>
					</tr>
					<tr>
						<td>
