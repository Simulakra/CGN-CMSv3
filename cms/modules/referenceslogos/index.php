...
if ($_POST) {//Form gönderildi mi? 
		...
		if (move_uploaded_file($_FILES["resim"]["tmp_name"], $yeni_ad))
						{ 
						$sorgu = mysqli_query($GLOBALS["___mysqli_ston"], "insert into 35cgnreferenceslogos (filename,link) values ('$yeni_ad','$link')"); 
...
<div id="page-wrapper">
<div class="row">
<div class="col-lg-12"><h1 class="page-header">Referans Logoları Yönetimi</h1></div>
<div class="col-lg-12">
<div class="panel panel-default">
<div class="panel-body">

            <?php 
                    $sorgu2 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from 35cgnreferenceslogos ORDER BY id ASC"); 
                    if (mysqli_num_rows($sorgu2)) 
					{ 
                        while ($kayit = mysqli_fetch_array($sorgu2)) 
						{ 
										$adi = $kayit["filename"]; 
										echo '<div class="col-lg-3 col-md-4">	<div class="panel panel-default"> 	<div class="panelbody slider-list">'; 
										echo '<img slider-list-self src="' . $adi . '" width="100%" height="auto"/>'; 
										echo '</div>'; 
...
<br>					
<small><div class="alert alert-warning">Görseller otomatik olarakküçültüleceklerdir.   Logolar yüklenme tarihine göre sıralanacaktır. Optimum görüntü için <b> 190px (en) x 110px (boy)</b>oranını  kullanınız</div></small>
