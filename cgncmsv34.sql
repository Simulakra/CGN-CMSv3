...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 14 Ara 2018, 15:03:05
...
--
-- Tablo için indeksler `35cgnproductalarm`
--
ALTER TABLE `35cgnproductalarm`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `35cgnproductbarkod`
--
ALTER TABLE `35cgnproductbarkod`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `barkod` (`barkod`);

--
-- Tablo için indeksler `35cgnproductislem`
--
ALTER TABLE `35cgnproductislem`
  ADD PRIMARY KEY (`id`);
...
--
-- Tablo için AUTO_INCREMENT değeri `35cgnproductislem`
--
ALTER TABLE `35cgnproductislem`
