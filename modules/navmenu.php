...
while($row = mysqli_fetch_array($result)) { 
    ...
    {   
        echo "<li><a href=\"category?uid=0\">".$row["menu_title"]."</a>"; 
        ...
        { 
            echo "<ul>"; 
            echo "<li><a href=\"category?uid=0\">Tüm Kategoriler</a></li>";
            while($row4 = mysqli_fetch_array($result4)) 
            {   echo "<li><a href=\"category?uid=".$row4['id']."\">".$row4["name"]."</a></li>";    } 
            echo "</ul></li>"; 
        } 
        else 
        {   echo "</li>";   } 
    ...
    {   echo "<li><a href=\"news\">".$row["menu_title"]."</a></li>";    }
            ...
            while($row3 = mysqli_fetch_array($result3)) 
                {        
                    ...
                    {    $tempfull = $tempfull. "<li><a href=\"references\">".$row3["page_name"]."</a></li>";    }
                        ...
                        $tempfull = $tempfull."<li><a href=\"page?id=".$row3['page_id']."\">".$row3["page_name"]."</a></li>";
                    }
                } 
                
            echo "<li><a href=\"page?menu=".$row['menu_id']."\">".$row["menu_title"]."</a><ul>"; 
            echo $tempfull;
            echo "</ul></li>"; 
            
        } 
        else 
        {   echo "<li><a href=\"page?menu=".$row['menu_id']."\">"."!-".$row["menu_title"]."</a></li>";   } 
    } 
} 
echo "</ul>"; 
?> 
